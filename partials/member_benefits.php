...
<span class="title">Membership in the Auditory Implant Initiative has many benefits. Some of these benefits are listed below:</span><br><br>
<ul class="list-group">
  ...
  <li class="list-group-item">
As providers enter data into the AII Portal, this information is collected in aggregate to be analyzed for research purposes. You can know that by participating in AII, you are participating in research that will directly benefit your patients. 
      </li>
...
Membership in AII allows providers to join together as "Virtual Care Teams".  These teams function as an integrated CI team regardless of physical location.  Additionally, the members of AII function as a network of like-minded colleagues who can share ideas, lend support or assist in patient care. 
    ...
    <li class="list-group-item">
Our Professional Forum on the AII website allows members to join in professional and academic discussion. This platform also serves as a mechanism for rapid dissemination of best practices and useful solutions.
    <li class="list-group-item"><span class="pull-left"><i class="fa fa-check-square-o fa-2x"></i></span><span class="title">Standardize your implant care processes</span></li>
    <li class="list-group-item">
By participating and entering patient data in the AII Portal, you will be guided through processes that will standardize care. You can know that you are measuring outcomes in a way that is standard among members.  Communicating with other providers will be easier when you know you are speaking the same language. You can send and receive referrals from other AII members with increased trust.
    </li>
...
The AII Portal will notify all members of the "Virtual Care Team" when scheduled follow up appointments are missed. Let AII become a built in safety net to keep your patients from falling through the cracks. 
    ...
    <li class="list-group-item">
On a periodic basis, AII members will be provided with reports comparing facility outcomes with the aggregate data.  This information will help you focus on areas that can be improved and celebrate bright areas of your practice. 
    </li>
</ul>