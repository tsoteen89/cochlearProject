    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <img src="<?php echo asset_url();?>images/AIILogoLight.png" height="60px"><br>
                Auditory Implant Initiative</a>
            </div>
            ...
            <div class="col-md-3 col-sm-4 sidebar">
                <ul class="nav nav-stacked nav-pills">
                    ...
                    foreach($Menu['SideBar'] as $Link){
                        if(array_key_exists('subMenu',$Link)){
                            echo'<li class="disabled"><a href="'.$Link['URI'].'">'.$Link['Label'].'</a></li>';
                            foreach($Link['subMenu'] as $SubMenu){
                                echo'<li><a href="'.$SubMenu['URI'].'" style="padding-left:40px">'.$SubMenu['Label'].'</a></li>';
                            }
